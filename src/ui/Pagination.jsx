...
function Pagination({ count }) {
  ...
  const totalPages = Math.ceil(count / DATA_PER_PAGE);
  ...
  return (
    <StyledPagination>
      <P>
        Showing <span>{(currentPage - 1) * DATA_PER_PAGE + 1}</span> to{" "}
        <span>
          {currentPage === totalPages ? count : currentPage * DATA_PER_PAGE}
        </span>{" "}
